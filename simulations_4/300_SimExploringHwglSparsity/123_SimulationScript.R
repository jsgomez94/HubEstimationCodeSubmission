...
index  <- 1
main_folder <- "300_SimExploringHwglSparsity/"
...
subfolder_bic_data   <- paste0(subfolder, "bic_data/")        ## Folder with BIC simulation outcomes.
subfolder_bic_plots  <- paste0(subfolder, "bic_plots/")       ## Folder to save BIC visualization plots.
